...
<nav class="navbar navbar-expand navbar-dark bg-primary">
    <ul class="navbar-nav nav-fill w-100">
        ...
        <c:if test="${empty UID}">
        <li class="nav-item">
            <a class="nav-link" href="/join/agree">회원가입</a></li>
        </c:if>
        <c:if test="${not empty UID}">
            <li class="nav-item">
                <a class="nav-link disabled" href="/join/agree">회원가입</a></li>
        </c:if>
        ...
        <c:if test="${not empty UID}">
        <li class="nav-item">
            <a class="nav-link" href="/join/myinfo">내 정보</a></li>
        </c:if>
        <c:if test="${empty UID}">
            <li class="nav-item">
                <a class="nav-link disabled" href="/join/myinfo">내 정보</a></li>
        </c:if>
